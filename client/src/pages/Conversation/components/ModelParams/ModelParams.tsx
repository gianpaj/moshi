...
export const ModelParams: FC<ModelParamsProps> = ({
  ...
  return (
    <div className="mt-6 flex flex-col items-center self-center p-2 text-center text-white">
      <table>
        <tbody>
          <tr>
          ...
          <tr>
            ...
            <td className="p-2">
              <input
                ...
                max="500"
                value={audioTopk}
                onChange={e => setAudioTopk(parseInt(e.target.value))}
              />
            </td>
          </tr>
          <tr>
            ...
            <td className="p-2">
              <input
                ...
                max="4"
                value={padMult}
                onChange={e => setPadMult(parseFloat(e.target.value))}
              />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="p-2">
              <input
                ...
                disabled={isConnected}
                type="range"
                id="repetition-penalty-context"
                name="repetition-penalty-context"
                step="1"
                min="0"
                max="200"
                value={repetitionPenaltyContext}
                onChange={e =>
                  setRepetitionPenaltyContext(parseFloat(e.target.value))
                }
              />
            </td>
          </tr>
      ...
      <div>
        <Button onClick={resetParams} className="m-2">
          Reset
        </Button>
        <Button onClick={() => modal?.current?.close()} className="m-2">
          Validate
        </Button>
      </div>
    </div>
